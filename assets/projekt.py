...
player1=pygame.image.load('Desktop/Mänguptojekt/assets/piksliplika/plika1.png').convert_alpha()
player2=pygame.image.load('Desktop/Mänguptojekt/assets/piksliplika/plika2.png').convert_alpha()
player_kõnd=[player1, player2]
player_index=0

player3=pygame.image.load('Desktop/Mänguptojekt/assets/piksliplika/plika3.png').convert_alpha()
player4=pygame.image.load('Desktop/Mänguptojekt/assets/piksliplika/plika4.png').convert_alpha()
